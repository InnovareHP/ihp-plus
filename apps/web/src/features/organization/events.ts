...
export const organizationEvents = {
  ...
  leadAdded: 'organization.department.lead_added',
  leadAddFailed: 'organization.department.lead_add_failed',
  leadRemoved: 'organization.department.lead_removed',
  leadRemoveFailed: 'organization.department.lead_remove_failed',
