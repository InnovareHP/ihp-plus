...
export const taskEvents = {
  ...
  timerStarted: 'tasks.timer.started',
  timerStartFailed: 'tasks.timer.start_failed',
  timerStopped: 'tasks.timer.stopped',
  timerStopFailed: 'tasks.timer.stop_failed',
  timeLogged: 'tasks.time.logged',
  timeLogFailed: 'tasks.time.log_failed',
  timeEntryDeleted: 'tasks.time.deleted',
  timeEntryDeleteFailed: 'tasks.time.delete_failed',
  timeSettingsSaved: 'tasks.time_settings.saved',
  timeSettingsSaveFailed: 'tasks.time_settings.save_failed',
